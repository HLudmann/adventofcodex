defmodule AdventOfCodex2021 do
  @moduledoc """
  Documentation for `AdventOfCodex2021`.
  """
  ...
  |> Enum.each(fn day ->
    def unquote(:"day#{day}")() do
      module = String.to_existing_atom("Elixir.AdventOfCodex2021.Day#{unquote(day)}")
  ...
  def all_days() do
    for day <- 1..@days_solved do
      module = String.to_existing_atom("Elixir.AdventOfCodex2021.Day#{day}")
      IO.puts("Day#{day}:\n\tpuzzle1: #{module.puzzle1()}\n\tpuzzle2: #{module.puzzle2()}")
    end
    :ok
  end
